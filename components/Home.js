...
function Home() {
  return (
    <section id="rooms" class="container mt-5">
      ...
      <h2 class='mb-3 ml-2 stays-heading'>Stays in Dar es salaam</h2>
          ...
          <div class="card p-2">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="ratings mt-auto mb-3">
                <p class="card-text"><b>120,000/=</b> per night</p>
          ...
          <div class="col-sm-12 col-md-6 col-lg-3 my-3">
            <div class="card p-2">
              ...
              <div class="card-body d-flex flex-column">
                ...
                <div class="ratings mt-auto mb-3">
                  <p class="card-text"><b>150,000/=</b> per night</p>
        ...
        <div class="col-sm-12 col-md-6 col-lg-3 my-3">
          <div class="card p-2">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="ratings mt-auto mb-3">
                <p class="card-text"><b>135,000/=</b> per night</p>
        ...
        <div class="col-sm-12 col-md-6 col-lg-3 my-3">
          <div class="card p-2">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="ratings mt-auto mb-3">
                <p class="card-text"><b>125,000/=</b> per night</p>
